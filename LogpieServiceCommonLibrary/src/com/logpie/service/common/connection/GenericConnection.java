...
public class GenericConnection
{
     ...
     *            Logpie callback.
     */
    public void send(CommonServiceCallback callback)
    {
        try
        {
        ...
        } catch (JSONException e1)
        {
            ...
            CommonServiceLog.e(TAG, "JSONException when putting request_id. Putting empty request_id");
        }
        ...
        if (data == null)
        {
            ...
            {
               CommonServiceLog.e(TAG, "JSONException when set the error message");
                e.printStackTrace();
            }
        ...
        {
            e.printStackTrace();
            CommonServiceLog.e(TAG, "geOutputStream occured error");
        ...
        } finally
        {
            ...
            {
                e.printStackTrace();
                CommonServiceLog.e(TAG, "error when try to close BufferedWriter");
            }
        }
        ...
        try
        {
            ...
            if (responsecode >= 200 && responsecode < 300)
            {
                ...
                else
                {
                    ...
                    CommonServiceLog.i(TAG, "successful sending data to: " + mServiceURL.getServiceName()
            ...
            else if (responsecode >= 300 && responsecode < 400)
            {
                ...
                CommonServiceLog.e(TAG, "redirection happen when sending data to server. error code:"
                        + responsecode);
            }
            else if (responsecode >= 400 && responsecode < 500)
            {
                handleCallback(false,
                        "client error happen when sending data to server. error code:"
                                + responsecode, callback);
                CommonServiceLog.e(TAG, "client error happen when sending data to server. error code:"
                        + responsecode);
            }
            else if (responsecode >= 500)
            {
                handleCallback(false, "server error when sending data to server. error code:"
                        + responsecode, callback);
                CommonServiceLog.e(TAG, "server error when sending data to server. error code:"
                        + responsecode);
            }
            else if (responsecode == -1)
            {
                handleCallback(false,
                        "no valid response code when sending data to server. error code:"
                                + responsecode, callback);
                CommonServiceLog.e(TAG, "no valid response code when sending data to server. error code:"
                        + responsecode);
            }
            else
            {
                handleCallback(false, "unknown error when sending data to server. error code:"
                        + responsecode, callback);
                CommonServiceLog.e(TAG, "unknown error when sending data to server. error code:"
                        + responsecode);
            }
        } catch (IOException e)
        {
    ...
    private void handleCallback(boolean isSuccess, String message, CommonServiceCallback callback)
    {
        ...
        if (isSuccess)
        {
            ...
            {
                CommonServiceLog.e(TAG, "JSONException when putting success message");
                e.printStackTrace();
            }
        ...
        else
        {
            ...
            {
                CommonServiceLog.e(TAG, "JSONException when putting error message");
                e.printStackTrace();
            }
    ...
    private void handleCallbackWithResponseData(String message, CommonServiceCallback callback)
    ...
    public JSONObject sendAndGetResult(CommonServiceCallback callback)
    {
        return new JSONObject();
    }
