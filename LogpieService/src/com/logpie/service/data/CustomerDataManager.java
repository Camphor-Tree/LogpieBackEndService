...
public class CustomerDataManager extends DataManager
{
    ...
    {   	
		try {
			...
			CommonServiceLog.e(TAG, "SQLException happened when building all result set of query request", e);
		} catch (JSONException e) {
			CommonServiceLog.e(TAG, "JSONException happened when building all result set of query request", e);
		}
    }
}
